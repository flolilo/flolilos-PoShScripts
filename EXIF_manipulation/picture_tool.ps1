...
# DEFINITION: Combine all parameters into a hashtable, then delete the parameter variables:
    ...
    Remove-Variable -Name InputPath,Convert2JPEG,EXIFManipulation,EXIFDeleteAll,EXIFAddCopyright,EXIFPresetName,EXIFArtistName,EXIFCopyrightText,Formats,ConvertQuality,ConvertRemoveSource,Convert2SRGB,ConvertScaling,EXIFtool,Magick,MagickThreads
...
Function Start-Everything(){
    ...
    if($UserParams.EXIFManipulation -eq 1){
